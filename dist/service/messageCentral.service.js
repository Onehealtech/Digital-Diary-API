...
exports.messageCentralService = void 0;
...
class MessageCentralService {
     ...
     */
    async sendOTP(mobileNumber, key) {
     ...
     */
    async verifyOTP(mobileNumber, key, code) {
        if (!this.isConfigured) {
...
exports.messageCentralService = new MessageCentralService();

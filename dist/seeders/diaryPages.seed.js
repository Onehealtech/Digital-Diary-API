...
function doneReportQuestions(testName, testNameHi, extra) {
    const qs = [];
    if (extra) {
        qs.push(...extra);
    }
    ...
    qs.push({ id: `q${nextIdx}`, text: `${testName} Report Collected`, textHi: `${testNameHi} रिपोर्ट प्राप्त की गई`, type: "yes_no", category: "completion" }, { id: `q${nextIdx + 1}`, text: "Facing A Major Problem With This Test", textHi: "मुझे इस टेस्ट में एक बड़ी समस्या आ रही है", type: "yes_no", category: "problem" }, { id: `q${nextIdx + 2}`, text: "Facing a Major Problem Getting This Report", textHi: "इस रिपोर्ट को प्राप्त करने में बड़ी समस्या का सामना करना पड़ रहा है।", type: "yes_no", category: "problem" });
    return qs;
}
...
async function seedDiaryPages() {
    ...
    for (const page of PAGES) {
        await DiaryPage_1.DiaryPage.create({

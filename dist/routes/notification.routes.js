...
router.post("/notifications/:id/respond", (0, authMiddleware_1.authCheck)([constants_1.UserRole.SUPER_ADMIN, constants_1.UserRole.DOCTOR, constants_1.UserRole.ASSISTANT, constants_1.UserRole.VENDOR, constants_1.UserRole.PATIENT]), notification_controller_1.notificationController.respondToNotification);

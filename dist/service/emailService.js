...
exports.sendDoctorRequestEmail = exports.sendAppointmentRejectionEmail = exports.sendOTPEmail = exports.sendPasswordResetEmail = exports.sendPasswordEmail = void 0;
 ...
 */
const sendPasswordEmail = async (email, password, role, fullName) => {
 ...
 */
const sendAppointmentRejectionEmail = async (staffEmail, staffName, patientName, appointmentType, appointmentDate, rejectReason) => {
    const mailOptions = {

...
exports.isDocumentAIConfigured = exports.extractWithDocumentAI = void 0;
 ...
 */
async function extractWithDocumentAI(imageBuffer, mimeType, questions) {
    if (!PROCESSOR_ID) {
        throw new Error("DOCUMENT_AI_PROCESSOR_ID is not set. Create a custom extractor in Google Cloud Console and set the processor ID in .env");
    }
...
exports.extractWithDocumentAI = extractWithDocumentAI;
/**
 * Check if Document AI is configured and ready to use.
 */
function isDocumentAIConfigured() {
    return !!PROCESSOR_ID;
}
exports.isDocumentAIConfigured = isDocumentAIConfigured;

...
type PermissionKey = 'viewPatients' | 'callPatients' | 'exportData' | 'sendNotifications' | 'sendAppointments' | 'deactivatePatients' | 'sellDiary' | 'manageOnboardingRequests' | 'markReviewed' | 'fillReport';

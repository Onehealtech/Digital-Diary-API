...
router.use("/v1/welcome", welcome_routes_1.default); // Versioned welcome route
router.use("/welcome", welcome_routes_1.default); // Direct welcome route alias: /api/welcome

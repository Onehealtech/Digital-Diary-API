...
__decorate([
    ...
    __metadata("design:type", String)
], UserSubscription.prototype, "diaryId", void 0);
__decorate([
    ...
    __metadata("design:type", String)
], UserSubscription.prototype, "doctorId", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => Appuser_1.AppUser, "doctorId"),
    __metadata("design:type", Appuser_1.AppUser)
], UserSubscription.prototype, "doctor", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.ENUM("ACTIVE", "EXPIRED", "CANCELLED", "UPGRADED"),
        allowNull: false,
        defaultValue: "ACTIVE",
    }),
    __metadata("design:type", String)
...
], UserSubscription.prototype, "paidAmount", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
    ...
    __metadata("design:type", Number)
], UserSubscription.prototype, "maxDiaryPages", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
...
], UserSubscription.prototype, "scanEnabled", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.BOOLEAN,
        allowNull: false,
    ...
    __metadata("design:type", Boolean)
], UserSubscription.prototype, "manualEntryEnabled", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.INTEGER,
        allowNull: false,
    ...
    __metadata("design:type", Number)
], UserSubscription.prototype, "pagesUsed", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.STRING,
        allowNull: true,
    ...
    __metadata("design:type", String)
], UserSubscription.prototype, "paymentOrderId", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.STRING,
        allowNull: true,
